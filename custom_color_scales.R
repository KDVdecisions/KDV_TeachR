...
# Googling led me to a blog post by @drsimonj: https://drsimonj.svbtle.com/creating-corporate-colour-palettes-for-ggplot2  There are several coding practices in this blog that are not good practice, but I could recreate the example, modify it, and then update it to follow good coding principals.
...
test <- new_pal(x=yukon_palettes, palette="warm")(20)
par(mar = rep(0, 4))
